...
import {
  TbBook, TbApps, TbChecklist, TbShoppingCartDollar, TbLogout, TbBook2, TbBulb, TbFileAlert, TbTooltip, TbBinaryTree, TbBuildingFortress, TbBuildingCommunity,
  TbDatabaseCog, TbHome, TbFileDelta, TbFile3D, TbCircleArrowLeftFilled, TbBadges, TbBuilding, TbChevronRight,
  TbCircleCheck, TbBuildingEstate, TbFileChart, TbFileDots, TbFileCode, TbFileCode2, TbUsers, TbUser, TbHexagonLetterR, TbBinaryTree2,
  TbTarget, TbMapPin, TbChartBar, TbCalendarShare, TbCalendar, TbHexagonLetterV, TbHexagonLetterM, TbClipboardText, TbZoomExclamation,
  TbListDetails, TbAlertTriangle, TbDatabasePlus, TbCalendarPlus, TbFocus2, TbBuildingCottage, TbCalendarStar, TbChartPie, TbListTree,
  TbFileImport, TbFileCheck, TbRubberStamp, TbAB2, TbDice4Filled, TbCircleFilled, TbLockSquareRounded, TbLockSquare, TbUserSearch, TbLockSquareRoundedFilled,
  TbUserQuestion, TbLayoutList, TbShieldSearch, TbWorldSearch, TbFlag, TbFlagPin, TbPencilPlus, TbClipboardCheck,
  TbAppsFilled, TbCurrencyDollar, TbFiles, TbCardsFilled, TbChartDots3,
} from "react-icons/tb";
        ...
        <ul className="pt-6">
          ...
          {User?.roles == "super_admin" && (
            <div className={`transition-all duration-300 ease-in-out ${DataMaster ? "px-3 py-2 flex flex-col border-l-2 border-white rounded-b-xl ml-2  max-h-screen opacity-100" : "max-h-0 opacity-0 pointer-events-none"}`}>
              ...
              <Link href="/DataMaster/jenis-inovasi">
                <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl transition-all duration-300 ease-in-out ${url === "/DataMaster/jenis-inovasi" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
              ...
              <Link href="/DataMaster/isu-klhs">
                <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl transition-all duration-300 ease-in-out ${url === "/DataMaster/isu-klhs" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
              ...
              <Link href="/DataMaster/bidang-urusan-opd">
                <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl transition-all duration-300 ease-in-out ${url === "/DataMaster/bidang-urusan-opd" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                  ...
                  <span className={`${!isOpen && "hidden"} origin-left duration-200 text-sm`}>
                    Bidang Urusan OPD
                  </span>
                </li>
              </Link>
            ...
            User?.roles == "reviewer") && (
              <div className={`transition-all duration-300 ease-in-out ${DataMasterOpd ? "px-3 py-2 flex flex-col border-l-2 border-white rounded-b-xl ml-2  max-h-screen opacity-100" : "max-h-0 opacity-0 pointer-events-none"}`}>
                ...
                <Link href="/DataMasterOpd/potensi-perangkat-daerah">
                  <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl transition-all duration-300 ease-in-out ${url === "/DataMasterOpd/potensi-perangkat-daerah" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                ...
                <Link href="/DataMasterOpd/nspk">
                  <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl transition-all duration-300 ease-in-out ${url === "/DataMasterOpd/nspk" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                ...
                >
                  ...
                  <TbChevronRight className={`transition-all duration-200 ease-in-out ${Isu ? "rotate-90" : ""}`}/>
                </li>
                {/* SUBS MENU RENSTRA */}
                <div className={`transition-all duration-300 ease-in-out ${Isu ? "px-3 py-2 flex flex-col border-l-2 border-white rounded-b-xl ml-2  max-h-screen opacity-100" : "max-h-0 opacity-0 pointer-events-none"}`}>
                  <Link href="/DataMasterOpd/isu-global">
                    <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl ${url === "/DataMasterOpd/isu-global" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                  ...
                  <Link href="/DataMasterOpd/isu-nasional">
                    <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl ${url === "/DataMasterOpd/isu-nasional" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                  ...
                  <Link href="/DataMasterOpd/isu-regional">
                    <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl ${url === "/DataMasterOpd/isu-regional" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                ...
                <Link href="/DataMasterOpd/ikk">
                  <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl transition-all duration-300 ease-in-out ${url === "/DataMasterOpd/ikk" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                    <TbLockSquare className="text-xl" />
                    <span className={`${!isOpen && "hidden"} origin-left duration-200`}>
                      Master IKK
                    </span>
                ...
                <Link href="/DataMasterOpd/master-rb">
                  <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl transition-all duration-300 ease-in-out ${url === "/DataMasterOpd/master-rb" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                    <TbDice4Filled className="text-xl" />
                    <span className={`${!isOpen && "hidden"} origin-left duration-200`}>
                      Master RB
                    </span>
            ...
            <div className={`transition-all duration-300 ease-in-out ${PerencanaanOPD ? "px-3 py-2 flex flex-col border-l-2 border-white rounded-b-xl ml-2  max-h-screen opacity-100" : "max-h-0 opacity-0 pointer-events-none"}`}>
              ...
              <div className={`transition-all duration-300 ease-in-out ${Renstra ? "px-3 py-2 flex flex-col border-l-2 border-white rounded-b-xl ml-2  max-h-screen opacity-100" : "max-h-0 opacity-0 pointer-events-none"}`}>
                ...
                <Link href="/Renstra/permasalahan&isustrategisopd">
                  <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl ${url === "/Renstra/permasalahan&isustrategisopd" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                ...
                <Link href="/Renstra/nspk">
                  <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl ${url === "/Renstra/nspk" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
          ...
          <div className={`transition-all duration-300 ease-in-out ${Laporan ? "px-3 py-2 flex flex-col border-l-2 border-white rounded-b-xl ml-2  max-h-screen opacity-100" : "max-h-0 opacity-0 pointer-events-none"}`}>
            ...
            <Link href="/laporaninovasi">
              <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl ${url === "/laporaninovasi" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
                <TbListDetails className="text-xl" />
                <span className={`${!isOpen && "hidden"} origin-left duration-200`}>
                  Inovasi
                </span>
