...
import TableIsuStrategis from "../Renstra/permasalahan&isustrategisopd/TableIsuStrategis";
import TablePermasalahan from "../Renstra/permasalahan&isustrategisopd/TablePermasalahan";
...
const IsuStrategisOpdView = () => {
    ...
    if (LoadingBranding) {
        ...
        if (
            ...
            ((branding?.user?.roles == "super_admin" || branding?.user?.roles == "reviewer") && branding?.opd?.value === undefined)
        ) {
...
export default IsuStrategisOpdView;
