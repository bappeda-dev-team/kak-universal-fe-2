...
import InovasiMaster from "@/components/pages/rencanakinerja/Rincian/Inovasi-master";
      ...
      {User?.roles != "level_4" && User?.roles != "level_2" ? (
        <>
          <div className="my-5">
            ...
            <Musrebang id={id_rekin} nip={User?.nip} />
            <SubKegiatan
              id={id_rekin}
              tahun={Tahun?.value}
            ...
            <Sakip id={id_rekin} />
            <Renaksi id={id_rekin} />
            <DasarHukum id={id_rekin} nip={User?.nip} />
            <GambaranUmum id={id_rekin} nip={User?.nip} />
            <Permasalahan
              tahun={Tahun?.value}
              kode_opd={User?.kode_opd}
              id={id_rekin}
            ...
            <div className="w-full my-4">
              <ButtonGreen
                onClick={() => {
                  AlertNotification(
                    "Tersimpan",
                    "Data rincian rencana kinerja berhasil disimpan",
                    "success",
                    2000,
                  );
