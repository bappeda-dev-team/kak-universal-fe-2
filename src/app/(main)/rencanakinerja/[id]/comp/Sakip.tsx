...
import { TbFileDescription, TbPencil } from "react-icons/tb";
...
const Sakip: React.FC<id> = ({ id }) => {
    ...
    const handleManualIk = (url: string) => {
        setProsesIk(true);
        router.push(`/rencanakinerja/manual_ik/${url}`);
    }
                                            ...
                                            <React.Fragment key={i.id_indikator}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="px-2 py-2 border">
                                                        <ButtonSkyBorder
                                                            disabled={ProsesIk}
                                                            onClick={() => handleManualIk(i.id_indikator)}
                                                        >
                                                            {ProsesIk ?
