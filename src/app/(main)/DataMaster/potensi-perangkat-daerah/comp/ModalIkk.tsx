...
import { PotensiFindall, FormValue } from "../type";
  ...
  const onSubmit: SubmitHandler<FormValue> = async (data) => {
    ...
    try {
      ...
      if (result.code === 201 || result.code === 200) {
        AlertNotification(
          "Berhasil",
          `Berhasil ${jenis === "edit" ? "mengubah" : "menambah"} Potensi Perangkat Daerah`,
          "success",
          1000,
        );
        onSuccess();
        ...
        >
          <div className="w-max-[500px] py-2 border-b text-center">
            <h1 className="text-xl uppercase">
              {jenis} Potensi Perangkat Daerah
            </h1>
          </div>
          <form
              ...
              <Controller
                ...
                render={({ field }) => (
                  <input
                    ...
                    placeholder={`Masukkan potensi perangkat daerah`}
                  />
                )}
              />
            </div>
