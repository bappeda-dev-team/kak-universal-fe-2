        ...
        const fetchTematikKab = async () => {
            ...
            try {
                ...
                if (result.code == 500 || result.code == 400) {
                    ...
                    if (data.pernyataan_kondisi_strategis) {
                        setPernyataanKonsidi(data.pernyataan_kondisi_strategis);
                        reset((prev) => ({ ...prev, pernyataan_kondisi_strategis: data.pernyataan_kondisi_strategis }))
                    }
                    if (data.alasan_sebagai_kondisi_strategis) {
                        setAlasanKondisi(data.alasan_sebagai_kondisi_strategis);
                        reset((prev) => ({ ...prev, alasan_sebagai_kondisi_strategis: data.alasan_sebagai_kondisi_strategis }))
                    }
                    ...
                    if (data.kondisi_yang_ingin_diwujudkan) {
                        setKondisiDiwujudkan(data.kondisi_yang_ingin_diwujudkan);
                        reset((prev) => ({ ...prev, kondisi_yang_ingin_diwujudkan: data.kondisi_yang_ingin_diwujudkan }))
                    }
                    if (data.nama_pohon) {
